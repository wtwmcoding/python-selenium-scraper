...
###### Export data to .csv ######
with open(changes_dataset_csv, 'w', newline='') as csv_file:
	writer = csv.writer(csv_file)
	writer.writerows(changes_dataset)
with open(new_dataset_csv,'w', newline='') as csv_file:
	writer = csv.writer(csv_file)
	writer.writerows(new_dataset)
print("Writing Complete")
subprocess.call(r'path/to/new_dataset_csv', shell=True)
subprocess.call(r'path/to/changes_dataset_csv', shell=True)